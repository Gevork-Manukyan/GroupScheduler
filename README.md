...
- Let each person submit a display name and tap the dates they can make
- Switch between calendar and list layouts on the shared group page
...
A date is only reported as working for everyone once at least two people have
replied — a single response is not a consensus.
